...
export default function Footer() {
    ...
    return(
        <div className="bg-white h-fit px-6 flex flex-row place-content-center pb-10">
            ...
            <div className="flex flex-row w-11/12 place-self-center mt-20">
                <div className="flex flex-col place-self-center text-left text-gray-500">
                    <img src={LOGO} className="size-12 mb-5" alt="Logo" />
                    <h1 className="text-notblack font-bold mb-5 text-2xl">Farm ni Ville</h1>
                ...
                <div className="flex flex-row justify-end my-10 space-x-40 mr-10 text-left">
                    ...
                    <div className="flex flex-col items-start text-gray-500">
                        ...
                        <Link to="/shop">
                        <p className="text-sm mb-1">Shopping Page</p>
                        </Link>
                        <Link to="/profile">
                        <p className="text-sm mb-1">My Profile</p>
                        </Link>
                        <Link to="/manage-orders">
                        <p className="text-sm mb-1">Manage Orders</p>
                        </Link>
                    </div>

                    <div className="flex flex-col items-start">
                        <h3 className="text-notgreen text-lg mb-2 flex flex-row font-semibold">Connect with Us</h3>
